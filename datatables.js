...
(function( factory ) {
	...
	function _fnDraw( oSettings, ajaxComplete )
	{
		...
		$(oSettings.nTableWrapper).toggleClass('dt-empty-footer mt-5', $('tr', oSettings.nTFoot).length === 0);
	...
	function _fnCalculateColumnWidths(settings) {
		...
		for (var i = 0; i < visibleColumns.length; i++) {
			var columnIdx = visibleColumns[i];
			...
			// You can perform any other operations related to column width here, if needed
	
			// Below is an example of adding the longest content to a temporary table cell
			$('<td/>')
				.addClass(autoClass)
				.addClass(column.sClass)
				.append(insert)
				.appendTo($('<tr/>'))
				.css('display', 'none'); // Hide the cell to avoid affecting layout
		}
	}
